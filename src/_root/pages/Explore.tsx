...
const Explore = () => {
  ...
  const { data: searchedPosts, isFetching: areSearchResultsLoading } = useSearchPosts(debouncedValue);
  ...
  const areSearchResultsShown = searchValue !== '';
  const arePostsShown = !areSearchResultsShown && posts.pages.every((page) => page?.documents.length === 0);
    ...
    <div className='explore-container'>
      <div className="explore-inner_container">
        ...
        <div className="flex gap-1 px-4 w-full rounded-lg bg-dark-4">
          <img src="/public/assets/icons/search.svg" alt="search-post" width={24} height={24} />
      ...
      <div className="flex flex-wrap gap-9 w-full max-w-5xl">
        {areSearchResultsShown ? (
          <SearchResults areSearchResultsLoading={areSearchResultsLoading} searchedPosts={searchedPosts} />
        ) : arePostsShown ? (
